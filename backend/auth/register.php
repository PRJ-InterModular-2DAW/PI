...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errores)) {
        ...
        $data = [
            ...
            "contrasenya" => password_hash($contrasenya, PASSWORD_DEFAULT), // Xifrat
            "email" => $email,
            "nom" => $nom,
            "cognoms" => $cognoms,
...
<body>
    ...
    <form method="POST" action="register.php">
        ...
        <input type="text" id="nom_usuari" name="nom_usuari" value="<?= htmlspecialchars($nomUsuari ?? '') ?>" required><br><br>
